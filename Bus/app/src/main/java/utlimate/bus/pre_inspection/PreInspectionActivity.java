...
import utlimate.bus.FetchLocationTask;
import utlimate.bus.GeofenceEditorActivity;
import utlimate.bus.GeofenceTransitionIntentService;
import utlimate.bus.R;


public class PreInspectionActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private static final String TAG = PreInspectionActivity.class.getSimpleName();
    ...
    String res;
    Button nextBtn;
    List<LatLng> latLngsArr = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  fetchLocationFromDb();
        ...
        mapFragment.getMapAsync(PreInspectionActivity.this);
        ...
        new FetchLocationTask() {
            ...
            public void onPostExecute(String result) {
                ...
                if (getResponseCode() == 200) {
                    ...
                    Toast.makeText(PreInspectionActivity.this, "Failed to load", Toast.LENGTH_LONG).show();
                }
...
//                startActivity(new Intent(this, FormActivity.class));
                if (latLngsArr.size()<4)
                {
                    Toast.makeText(PreInspectionActivity.this,"Please add atleast 4 coordinates",Toast.LENGTH_SHORT).show();

                }else {
                    double hector=  SphericalUtil.computeArea(latLngsArr) * Math.pow(10,-4);
                    if (hector<5)
                    {
                        Toast.makeText(PreInspectionActivity.this,"Submitted successfully ",Toast.LENGTH_SHORT).show();

                    }else {
                        Toast.makeText(PreInspectionActivity.this,"Subsidy is claimed for less than 5 hectors",Toast.LENGTH_SHORT).show();
...
//        mMap.setOnMarkerDragListener(this);
   ...
   @Override
    public void onMapLongClick(LatLng latLng) {
        mMarkers.add(mMap.addMarker(new MarkerOptions().position(latLng).draggable(true)));
        mMap.setOnMarkerDragListener(this);
       latLngsArr.add(latLng);
       Log.i(TAG, "computeArea " + SphericalUtil.computeArea(latLngsArr));
        update();
    }
