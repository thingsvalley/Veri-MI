...
import utlimate.bus.geotag.GeotaggingDataModel;
import utlimate.bus.geotag.GridImageAdapter;

import static android.provider.MediaStore.Files.FileColumns.MEDIA_TYPE_VIDEO;
import static utlimate.bus.MainActivity.isInGeoFence;

public class PreGeotagMainActivity extends AppCompatActivity implements LocationListener {
    ...
    ArrayList<Bitmap> mainLineList=new ArrayList<>();
    ArrayList<Bitmap> subLineList=new ArrayList<>();
    ArrayList<Bitmap> otherList=new ArrayList<>();
...
//    String ImageName = "image_name" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_pre_inspection);
            ...
            public void onClick(View v){
                ...
                if(isFormData)
                {
                    ...
                    if (isInGeoFence) {
                        ...
                        Toast.makeText(PreGeotagMainActivity.this, "You are outside of Geofence.", Toast.LENGTH_LONG).show();
                    }
                }
            ...
            public void onClick(View view) {
                ...
                for (int i=0;i<imageArray.size();i++)
                {
                    ...
                    if(bitmap!=null || !geotaggingDataModel.getLatitude().equals(" ") || !geotaggingDataModel.getLongitude().equals(" ")) {
                        ...
                        Toast.makeText(PreGeotagMainActivity.this,"Please add image.",Toast.LENGTH_SHORT).show();
                    }
...
//            imageView.setImageBitmap(bitmap)     ;
    ...
    private void setImagesToGrid() {
        GridImageAdapter recyclerView_Adapter=new GridImageAdapter(this,imageArray);
        gridView.setAdapter(recyclerView_Adapter);
    }
    //@Override
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(PreGeotagMainActivity.this)
                .setMessage(message)
    ...
    public void ImageUploadToServerFunction(Bitmap bitmap, final double lat, final double lon){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(PreGeotagMainActivity.this,string1, Toast.LENGTH_LONG).show();
