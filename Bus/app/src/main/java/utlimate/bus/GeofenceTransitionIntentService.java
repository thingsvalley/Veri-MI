...
import static utlimate.bus.LocationUpdateService.KEY_LATITUDE;
import static utlimate.bus.LocationUpdateService.KEY_LONGITUDE;
import static utlimate.bus.LocationUpdateService.KEY_POLYGON_POINTS_COUNT;
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        switch (transition) {
            case Geofence.GEOFENCE_TRANSITION_ENTER:
                ...
                showNotification("Entered the geofence.", NOTIFICATION_ENTER);
                startService(intent);
                break;
            ...
            case Geofence.GEOFENCE_TRANSITION_DWELL:
                ...
                startService(intent);
                showNotification("Dwells inside the geofence.", NOTIFICATION_DWELL);
                break;

            case Geofence.GEOFENCE_TRANSITION_EXIT:
                Log.d(TAG, "Exited the geofence.");
                showNotification("Exited the geofence.", NOTIFICATION_EXIT);
                stopService(intent);
                break;
